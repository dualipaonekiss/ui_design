...
import sys
import os
import distance_prediction
from yoloWorks.yolo_work import yoloWork
from line_work import line_work
from tkinter import filedialog
from distance_prediction import distance_predictionWork
import numpy as np
...
def btn_chooseVideo_action():
    ...
    while cap.isOpened():
        ...
        if success:
            ...
            if yoloworkObj.get_avg_frameAnd_personbbox(image):
                continue
            else:
                break
